...
<section class="kokoko3 bg-cover col-span-12 relative md:h-[calc(780px+5vw)] ">
  ...
  <section class="text-gray-700 body-font  sm:mt-0">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      ...
      <div class="sm:w-32 sm:order-none order-first sm:h-32 animate-bounce  h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
...
<section class="font-Poppins bg-dark_purple text-white">
<div className="text-center py-10">
    <h5 class="text-btn_color">New Projects</h5>
    <h1 class="text-4xl w-96 mx-auto leading-norm
    al font-bold text-black mb-12">Look at the magic of our work</h1>
    <div class=" max-w-5xl mx-auto gap-8 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-1 lg:grid-cols-3 xl:gap-x-8 group ">
        <div class="bg-white/10  duration-500 p-8 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 cursor-pointer rounded-xl mix-blend-luminosity ">
        ...
        <div class="bg-white/10   p-8 duration-500 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 cursor-pointer rounded-xl mix-blend-luminosity ">
           <img src={img2} class="h-60 mx-auto" />
           <h4 class="uppercase text-xl font-bold text-btn_color">SPORTING CLUB- saida</h4>
           <p class="text-sm leading-7 my-3 font-light text-btn_color ">m ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse at lectus quis elit vulputate ornare a in mauris. Curabitur id efficitur sapien. Quisque hendrerit ullamcorper lectus, in imperdiet magna fermentum ac.</p>
           <button class="bg-btn_color py-2.5 px-8 rounded-full"> Get in Touch</button>
        </div>
        <div class="bg-white/10  duration-500 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 cursor-pointer p-8 rounded-xl mix-blend-luminosity ">
